    ...
    return (
        <section className={isWhiteBg ? "cta-bg-white":"cta-bg"}>
            <div className="container">
                <div className={`${(cardType == 'triangles') ? "max-w-5xl text-blue-100" : "relative text-blue-200 max-w-4xl"} mx-auto bg-blue-600 rounded-xl shadow-2xl md:text-center`}>
                    {
                        cardType == "chess" && <div className="absolute inset-0 rounded-xl transition duration-300 [mask-image:linear-gradient(white,transparent)] ">
                            <svg aria-hidden="true" className="absolute inset-x-0 inset-y-[-30%] h-[160%] w-full fill-white/[0.06] stroke-white/10 bg-gradient-to-r from-blue-600 to-blue-400">
                                <defs>
                    ...
                    <div className={`${(cardType == 'triangles') ? "bg-triangles" :"relative"} rounded-xl bg-center`}>
                        <div className="px-10 md:px-24 py-16 bg-gradient-to-b from-blue-600/60 to-blue-600/95 rounded-xl">
                            ...
                            <Link href={action.url} className="mt-10 inline-flex bg-white px-3 py-3 rounded-xl text-slate-800 font-semibold text-sm shadow-lg shadow-blue-600 items-center hover:bg-slate-900 hover:text-white mix-blend-hard-light">

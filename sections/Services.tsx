        ...
        <section className="bg-white py-16 md:py-24 border-b border-slate-100">
            <div className="container">
                <div className="max-w-2xl">
                    ...
                    <Link href="/contact-us" className="font-semibold text-blue-600 hover:text-blue-700">Contact Us Now <span className="opacity-90 ml-1">→</span></Link>
                </div>
                <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                    <div>
                        <h3 className="font-semibold"><Link href="/web-development" title="Web Development Services" className="hover:text-blue-600">Web Development</Link></h3>
                    ...
                    <div>
                        <h3 className="font-semibold"><Link href="/ui-ux-design" title="UI/UX Design Services" className="hover:text-blue-600">UI/UX Design</Link></h3>
                    ...
                    <div>
                        <h3 className="font-semibold"><Link href="/software-development" title="Software Development Services" className="hover:text-blue-600">Software Development</Link></h3>
                    ...
                    <div>
                        <h3 className="font-semibold"><Link href="/mobile-app-development" title="Mobile App Development Services" className="hover:text-blue-600">Mobile App Development</Link></h3>
                    ...
                    <div>
                        <h3 className="font-semibold"><Link href="/strategy-consulting" title="Strategy &amp; Consulting Services" className="hover:text-blue-600">Strategy &amp; Consulting</Link></h3>
                    ...
                    <div>
                        <h3 className="font-semibold"><Link href="/quality-assurance-software-testing" title="Strategy &amp; Consulting Services" className="hover:text-blue-600">Quality Assurance &amp; Testing</Link></h3>

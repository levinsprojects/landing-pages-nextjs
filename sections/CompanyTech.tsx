            ...
            <div className="bg-brand-50 relative bg-opacity-80 py-16 md:py-24 backdrop-filter backdrop-blur-3xl">
                <div className="container grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="">
                        ...
                        <Link href="/about-us/our-story" className="font-semibold text-brand-600 hover:text-blue-800">Read Our Story <span className="opacity-90 ml-1">→</span></Link>
                    ...
                    <div className="bg-white rounded-xl shadow-2xl shadow-slate-900/10 border p-8 md:p-12 md:ml-16">
                        <div className="md:flex justify-between items-start">
                            <div>
                                <h5 className="text-brand-600 font-semibold">Starting services at just</h5>
                            ...
                            <Link href="/contact-us" className="inline-flex justify-center py-2 px-4 bg-footer-bg-900 text-sm font-semibold text-white rounded-lg hover:bg-slate-700 mt-6 md:mt-0">Contact Us
                        ...
                        <hr className="my-10" />
                        <div className="flex">
                            <div className="bg-brand-50 text-brand-600 border border-brand-100 flex flex-shrink-0 w-10 h-10 items-center justify-center rounded-lg">

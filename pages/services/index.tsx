...
const Page: NextPage = () => {
    return (
        <>
            ...
            <SectionWrapper>
                <>
                    <SectionDetailPanel heading="Our Services" content={["At Salt Technologies, we are committed to delivering high-quality software development services that help businesses of all sizes improve their operations and drive growth.","Our team of experienced developers are skilled in a variety of technologies and can work with you to create custom solutions that are tailored to your specific needs."]}></SectionDetailPanel>
